...
export function printGoodbye({ sessionId, sessionDate, hasMessages }: GoodbyeOptions): void {
  ...
  if (hasMessages) {
    console.log()
    console.log(`  ${chalk.gray('Session')}   ${chalk.white(`New session - ${sessionDate}`)}`)
    console.log(`  ${chalk.gray('Continue')}  ${colorFn(`null -s ${sessionId}`)}`)
    console.log()
  } else {
